...
if ((event.body.toLowerCase() == "😘") || (event.body.toLowerCase() == "😽")) {
  ...
  if ((event.body.toLowerCase() == "Raju vai") || (event.body.toLowerCase() == "Raju vai") || (event.body.toLowerCase() == "@Raju vai") || (event.body.toLowerCase() == "রাজু")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ RAJU ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Raju mals.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/share/19F11HKScr/\nতার সাতে যোগা যোগ করবেন WhatsApp :- +01815896135", threadID);
   };

   if ((event.body.toLrCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:RAJU ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস রাজু আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is raju ッ❤️ তাকে সবাই রাজু নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (evbossbody.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "@Ahmed'z Akhi") || (event.body.toLowerCase() == "@Ahmed'z Akhi ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস রাজুর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "akhi") || (event.body.toLowerCase() == "akhi")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রাজু এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@ta nvir") || (event.body.toLowerCase() == "ফাহিম")) {
     return api.sendMessage("🥰-ফহিম-🌺 আমার বস রাজু'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami raju") || (event.body.toLowerCase() == "kire")) {
